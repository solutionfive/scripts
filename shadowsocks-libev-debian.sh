...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/solutionfive/scripts/master/shadowsocks-libev-debian"
}
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev-debian install failed."
        exit 1
    fi
